-- DROP FUNCTION public.f_get_ddl_basic(text, text, json);

CREATE OR REPLACE FUNCTION public.f_get_ddl_basic(_sn text DEFAULT 'public'::text, _tn text DEFAULT ''::text, _opt json DEFAULT '{}'::json)
 RETURNS text
 LANGUAGE plpgsql
AS $function$
declare
